...
$('.sales').attr('href', 'mailto:sales@asiapay.co.id');
$('.sales').html('sales@asiapay.co.id');
$('.telno').html('+6221 - 5794 8575, +6221 – 2520155, +6221  - 2520219, +6221 – 2520245, +6221 – 2520270');
...
$('.about-f').html('PayDollar is a payment gateway platform developed by AsiaPay Limited, a leading payment service provider in the Asia Pacific region, for the Indonesian e-commerce space. PayDollar Indonesia provides merchants with the facility to accept payments online through credit cards, internet banking and alternative payment methods such as BCA KlikPay, mandiri clickpay, and more.');
// Navigation Config //
// Menu1 //
